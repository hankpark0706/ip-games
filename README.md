# Integer Programming — Model Games

Play in your browser (no login, no install). Start at **[index.html](index.html)**
for the "scan to play" landing page with a QR code for each game.

| Game | Model |
|------|-------|
| [assignment-matching.html](assignment-matching.html) | Assignment / matching |
